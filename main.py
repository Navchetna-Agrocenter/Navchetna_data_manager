...
st.sidebar.markdown("---")
st.sidebar.markdown("### 🚀 MongoDB Version Available!")
st.sidebar.info("A MongoDB-powered version with dynamic schema management is now available. Run `streamlit run mongodb_app.py` to try it!")
if st.sidebar.button("🔗 Learn More About MongoDB Version"):
    st.sidebar.markdown("""
